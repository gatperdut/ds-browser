...
"use strict";var _schemaOrgAdapter=_interopRequireDefault(require("schema-org-adapter")),_Util=_interopRequireDefault(require("./Util")),_DSHandler=_interopRequireDefault(require("./DSHandler")),_ListRenderer=_interopRequireDefault(require("./ListRenderer")),_DSRenderer=_interopRequireDefault(require("./DSRenderer")),_NativeRenderer=_interopRequireDefault(require("./NativeRenderer")),_TreeRenderer=_interopRequireDefault(require("./TreeRenderer")),_TableRenderer=_interopRequireDefault(require("./TableRenderer"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,r,t,n,i,s,a){try{var d=e[s](a),o=d.value}catch(e){return void t(e)}d.done?r(o):Promise.resolve(o).then(n,i)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(n,i){var s=e.apply(r,t);function a(e){asyncGeneratorStep(s,n,i,a,d,"next",e)}function d(e){asyncGeneratorStep(s,n,i,a,d,"throw",e)}a(void 0)})}}var BROWSER_TYPES={DS:"DS",LIST:"LIST"};class DSBrowser{constructor(e,r){var t=this,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:BROWSER_TYPES.DS;this.elem=e,this.dsOrList=r,this.type=n,this.path=null,this.util=new _Util.default(this),this.dsHandler=new _DSHandler.default(this),this.listRenderer=new _ListRenderer.default(this),this.dsRenderer=new _DSRenderer.default(this),this.nativeRenderer=new _NativeRenderer.default(this),this.treeRenderer=new _TreeRenderer.default(this),this.tableRenderer=new _TableRenderer.default(this),window.addEventListener("popstate",_asyncToGenerator(function*(){yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){e.elem.innerHTML='<div style="text-align: center"><img src="https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/loading.gif" alt="Loading Animation" style="margin-top: 6px;"></div>',yield e.init(),e.isShaclRendering()?e.dsRenderer.renderShacl():e.isNativeRendering()?e.nativeRenderer.render():e.isTreeRendering()?e.treeRenderer.render():e.isTableRendering()?e.tableRenderer.render():e.isListRendering()&&e.listRenderer.render(),e.addJSLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0})()}init(){var e=this;return _asyncToGenerator(function*(){e.listNeedsInit()&&(yield e.initList()),e.dsNeedsInit()?(yield e.initDS(),e.initDSNode()):e.dsNodeNeedsInit()&&e.initDSNode()})()}listNeedsInit(){return this.type===BROWSER_TYPES.LIST&&!this.list}initList(){var e=this;return _asyncToGenerator(function*(){e.list=yield e.util.parseToObject(e.dsOrList)})()}dsNeedsInit(){var e=new URLSearchParams(window.location.search).get("ds");return this.type===BROWSER_TYPES.LIST&&e&&e!==this.dsUID||this.type===BROWSER_TYPES.DS&&!this.ds}initDS(){var e=this;return _asyncToGenerator(function*(){if(e.type===BROWSER_TYPES.DS)e.ds=yield e.util.parseToObject(e.dsOrList);else if(e.type===BROWSER_TYPES.LIST){var r=new URLSearchParams(window.location.search);for(var t of(e.dsUID=r.get("ds"),e.list["schema:hasPart"])){var n=t["@id"];if(n.split("/").pop()===e.dsUID){e.ds=yield e.util.parseToObject(n);break}}}e.sdoAdapter=new _schemaOrgAdapter.default;var i=yield e.getVocabUrlsForDS();yield e.sdoAdapter.addVocabularies(i)})()}getVocabUrlsForDS(){var e=this;return _asyncToGenerator(function*(){var r=[];if(e.ds&&e.ds["@graph"][0]&&Array.isArray(e.ds["@graph"][0]["ds:usedVocabularies"])&&(r=e.ds["@graph"][0]["ds:usedVocabularies"]),e.ds&&e.ds["@graph"][0]&&e.ds["@graph"][0]["schema:schemaVersion"]){var t=e.getSDOVersion();r.push(yield e.sdoAdapter.constructSDOVocabularyURL(t))}return r})()}getSDOVersion(){return/.*schema\.org\/version\/([0-9\.]+)\//g.exec(this.ds["@graph"][0]["schema:schemaVersion"])[1]}initDSNode(){var e=new URLSearchParams(window.location.search);this.path=e.get("path"),this.dsNode=this.dsHandler.getDSNodeForPath()}dsNodeNeedsInit(){return new URLSearchParams(window.location.search).get("path")!==this.path}isShaclRendering(){var e=new URLSearchParams(window.location.search).get("format");return e&&"shacl"===e}isNativeRendering(){var e=new URLSearchParams(window.location.search),r=e.get("ds");return!e.get("mode")&&(this.type===BROWSER_TYPES.LIST&&r||this.type===BROWSER_TYPES.DS)}isTreeRendering(){var e=new URLSearchParams(window.location.search),r=e.get("ds");return"tree"===e.get("mode")&&(this.type===BROWSER_TYPES.LIST&&r||this.type===BROWSER_TYPES.DS)}isTableRendering(){var e=new URLSearchParams(window.location.search),r=e.get("ds");return"table"===e.get("mode")&&(this.type===BROWSER_TYPES.LIST&&r||this.type===BROWSER_TYPES.DS)}isListRendering(){var e=new URLSearchParams(window.location.search);return this.type===BROWSER_TYPES.LIST&&!e.get("voc")}addJSLinkEventListener(){var e=this,r=this.elem.getElementsByClassName("a-js-link"),t=function(r){r.addEventListener("click",function(){var t=_asyncToGenerator(function*(t){t.ctrlKey?window.open(r.href):(history.pushState(null,null,r.href),yield e.render())});return function(e){return t.apply(this,arguments)}}())};for(var n of r)t(n)}}module.exports=DSBrowser;
...
"use strict";class DSHandler{constructor(t){this.browser=t,this.util=t.util}getDSNodeForPath(){var t=this.browser.ds["@graph"][0],e={type:"",node:{}};if(this.browser.ds)if(this.browser.path){for(var r=this.browser.path.split("-"),s=0;s<r.length;s++)""!==r[s]&&(r[s].charAt(0).toUpperCase()===r[s].charAt(0)?null!==t&&(t=this.getClass(t["sh:or"],r[s])):null!==t&&s!==r.length-1&&(t=void 0!==t["sh:targetClass"]?this.getProperty(t["sh:property"],r[s]):this.getProperty(t["sh:node"]["sh:property"],r[s])));if(t&&t["sh:class"]&&!Array.isArray(t["sh:class"]))try{this.browser.sdoAdapter.getEnumeration(t["sh:class"]),e.type="Enumeration"}catch(t){e.type="Class"}else e.type="Class"}else e.type="Class";else e.type="error";return e.node=t,e}getClass(t,e){for(var r=0;r<t.length;r++)if(void 0!==t[r]["sh:class"]&&this.rangesToString(t[r]["sh:class"])===e)return t[r];return null}getProperty(t,e){for(var r=0;r<t.length;r++)if(this.rangesToString(t[r]["sh:path"])===e)return t[r];return null}dataTypeMapperFromSHACL(t){switch(t){case"xsd:string":return"http://schema.org/Text";case"xsd:boolean":return"http://schema.org/Boolean";case"xsd:date":return"http://schema.org/Date";case"xsd:dateTime":return"http://schema.org/DateTime";case"xsd:time":return"http://schema.org/Time";case"xsd:double":return"http://schema.org/Number";case"xsd:float":return"http://schema.org/Float";case"xsd:integer":return"http://schema.org/Integer";case"xsd:anyURI":return"http://schema.org/URL"}return null}rangesToString(t){return Array.isArray(t)?t.map(t=>this.util.prettyPrintIri(t)).join(" + "):this.util.prettyPrintIri(t)}createCardinality(t,e){var r,s="";return t&&0!==t?e&&0!==e?t!==e?(r="This property is required. It must have between "+t+" and "+e+" value(s).",s=t+".."+e):(r="This property is required. It must have "+t+" value(s).",s=t):(r="This property is required. It must have at least "+t+" value(s).",s=t+"..N"):e&&0!==e?(r="This property is optional. It must have at most "+e+" value(s).",s="0.."+e):(r="This property is optional. It may have any amount of values.",s="0..N"),'<span title="'+r+'">'+s+"</span>"}generateDsClass(t,e,r){var s,i={},a=t["sh:targetClass"];i.text=a?this.util.prettyPrintClassDefinition(a):this.util.prettyPrintClassDefinition(t["sh:class"]),i.icon="glyphicon glyphicon-list-alt",e||(i.state={opened:!0});try{s=-1===i.text.indexOf(",")?this.browser.sdoAdapter.getClass(i.text).getDescription():"No description found."}catch(t){s="No description found."}return i.data={},i.data.dsDescription=s,t["rdfs:comment"]&&(i.justification=t["rdfs:comment"]),i.children=this.processChildren(t,r),i}processChildren(t,e){var r,s=[],i=t["sh:property"],a=t["sh:node"];return i?r=i:a&&a["sh:property"]&&(r=a["sh:property"]),void 0!==r&&r.forEach(t=>{var r=this.generateDsProperty(t,e);r&&s.push(r)}),s}generateDsProperty(t,e){var r={};return r.justification=t["rdfs:comment"],r.text=this.util.prettyPrintIri(t["sh:path"]),r.data={},r.data.minCount=t["sh:minCount"],r.data.maxCount=t["sh:maxCount"],r.children=[],this.processEnum(r,t["sh:or"][0]),this.processVisibility(r,t["sh:minCount"]),this.processExpectedTypes(r,t["sh:or"],e),e?r:r.data.isOptional?void 0:r}processEnum(t,e){var r;t.isEnum=!1;try{var s=e["sh:class"];r=this.browser.sdoAdapter.getEnumeration(s),t.isEnum=!0}catch(t){}if(t.isEnum){var i=this.getEnumMemberArray(e["sh:in"],r);i.forEach(t=>{var e=this.browser.sdoAdapter.getEnumerationMember(t.name);t.description=this.util.repairLinksInHTMLCode(e.getDescription())}),t.data.enuMembers=i,t.children=i.map(t=>({children:[],data:{dsRange:"",dsDescription:this.util.repairLinksInHTMLCode(t.description)},icon:"glyphicon glyphicon-chevron-right",text:t.name}))}}getEnumMemberArray(t,e){return t?t.map(t=>{var e=t["@id"];return{name:e=e.replace("schema:","")}}):e.getEnumerationMembers().map(t=>({name:t}))}processVisibility(t,e){t.icon="glyphicon glyphicon-tag",!e>0?(t.icon+=" optional-property",t.data.isOptional=!0):(t.icon+=" mandatory-property",t.data.isOptional=!1)}processExpectedTypes(t,e,r){var s=!1;if(e){var i=this.generateDsRange(e);t.data.dsRange=i.rangeAsString,t.data.rangeJustification=i.rangeJustification;try{var a=this.browser.sdoAdapter.getProperty(t.text).getDescription();t.data.dsDescription=this.util.repairLinksInHTMLCode(a)}catch(e){t.data.dsDescription="No description found."}e.forEach(e=>{if(e["sh:node"]){s=!0;var i=this.generateDsClass(e,!0,r);t.children.push(i)}})}s&&(t.state={opened:!0})}generateDsRange(t){var e={rangeAsString:"",rangeJustification:[]};return e.rangeAsString=t.map((t,r)=>{var s,i,a={},n=t["sh:datatype"],o=t["sh:class"];return i=n?s=this.util.prettyPrintIri(this.dataTypeMapperFromSHACL(n)):t["sh:node"]?"<strong>"+(s=this.util.prettyPrintClassDefinition(o))+"</strong>":s=this.util.prettyPrintClassDefinition(o),a.name=s,a.justification=t["rdfs:comment"],e.rangeJustification.push(a),i}).join(" or "),e}}module.exports=DSHandler;

},{}],86:[function(require,module,exports){
"use strict";function _defineProperty(e,t,i){return t in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}class DSRenderer{constructor(e){_defineProperty(this,"MODES",{native:"native",tree:"tree",table:"table"}),this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler}renderShacl(){this.browser.elem.innerHTML='<pre style="font-size: medium; background: none; text-align: left; width: auto; padding: 0; overflow: visible; color: rgb(0, 0, 0); line-height: normal; display: block; font-family: monospace; margin: 1em 0; word-wrap: break-word; white-space: pre-wrap;">'+JSON.stringify(this.browser.ds,null,2)+"</pre>"}createViewModeSelectors(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this.MODES.native;return'<div class="ds-selector-tabs ds-selector"><div class="selectors">'+(e===this.MODES.native?'<a class="selected">Native View</a>':this.util.createJSLink("mode",null,"Native View"))+(e===this.MODES.tree?'<a class="selected">Tree View</a>':this.util.createJSLink("mode","tree","Tree View"))+(e===this.MODES.table?'<a class="selected">Table View</a>':this.util.createJSLink("mode","table","Table View"))+"</div></div>"}createHeader(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e,t,i="";if(this.browser.path){var r=this.node["sh:class"];e=this.dsHandler.rangesToString(r),t=this.createNodeDescription(r),i=this.createBreadcrumbs()}else{var s=this.browser.ds["@graph"][0];e=s["schema:name"]||"Domain Specification",t=s["schema:description"]||""}return t=this.util.repairLinksInHTMLCode(t),this.createNavigation()+'<h1 property="schema:name">'+e+"</h1>"+this.util.createExternalLinkLegend()+i+'<div property="schema:description">'+t+"<br><br></div>"}createNodeDescription(e){return this.util.isString(e)?this.browser.sdoAdapter.getTerm(e).getDescription():e.map(e=>"<b>"+this.util.prettyPrintIri(e)+":</b> "+this.browser.sdoAdapter.getTerm(e).getDescription()).join("<br>")}createBreadcrumbs(){return'<h4><span class="breadcrumbs">'+this.util.createJSLink("path",null,this.browser.ds["@graph"][0]["schema:name"]||"Domain Specification")+" > "+this.browser.path.split("-").map((e,t,i)=>{if(t%2==0)return e;var r=i.slice(0,t+1).join("-");return this.util.createJSLink("path",r,e)}).join(" > ")+"</span></h4>"}createNavigation(){return'<span style="float: right;">('+this.util.createJSLink("format","shacl","SHACL serialization")+(this.browser.list?" | from List: "+this.util.createJSLink("ds",null,this.browser.list["schema:name"]):"")+")</span>"}createVisBtnRow(){return'<div id="btn-row">Show: <span id="btn-opt" class="btn-vis btn-vis-shadow" style="margin-left: 10px;"><img src="" class="glyphicon glyphicon-tag optional-property"> optional</span><span id="btn-man" class="btn-vis" style="margin-left: 10px;"><img src="" class="glyphicon glyphicon-tag mandatory-property"> mandatory</span></div>'}}module.exports=DSRenderer;

},{}],87:[function(require,module,exports){
"use strict";class ListRenderer{constructor(e){this.browser=e,this.util=e.util}render(){var e=this.createHeader()+this.createDSTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e)}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"+this.util.createExternalLinkLegend()+this.browser.list["schema:description"]||""}createDSTable(){return this.util.createDefinitionTable(["Name","IRI","Description"],this.createDSTbody(),null,{class:"supertype"})}createDSTbody(){return this.browser.list["schema:hasPart"].map(e=>this.util.createTableRow("http://vocab.sti2.at/ds/Domain Specification",e["@id"],"schema:name",this.util.createJSLink("ds",e["@id"].split("/").pop(),e["schema:name"]||"No Name"),this.createDSSideCols(e))).join("")}createDSSideCols(e){return'<td property="@id">'+this.util.createLink(e["@id"])+'</td><td property="schema:description">'+(e["schema:description"]||"")+"</td>"}}module.exports=ListRenderer;

},{}],88:[function(require,module,exports){
"use strict";class NativeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e=this.dsRenderer.createHeader()+this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.native)+("Class"===this.dsNode.type?this.createClassPropertyTable():this.createEnumerationMembers());this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",e)}createClassPropertyTable(){var e=(this.browser.path?this.node["sh:node"]["sh:property"].slice(0):this.node["sh:property"].slice(0)).map(e=>this.createClassProperty(e)).join("");return this.util.createDefinitionTable(["Property","Expected Type","Description","Cardinality"],e,{style:"margin-top: 0px; border-top: none;"})}createClassProperty(e){var r=e["sh:path"],t=this.browser.sdoAdapter.getProperty(r);return this.util.createTableRow("rdf:Property",t.getIRI(),"rdfs:label",this.util.createTermLink(r),this.createClassPropertySideCols(e),"prop-name")}createClassPropertySideCols(e){return'<td class="prop-ect">'+this.createExpectedTypes(e)+'</td><td class="prop-desc">'+this.createClassPropertyDescText(e)+'</td><td class="prop-ect">'+this.dsHandler.createCardinality(e["sh:minCount"],e["sh:minCount"])+"</td>"}createClassPropertyDescText(e){var r=this.util.prettyPrintIri(e["sh:path"]),t="";try{t=this.browser.sdoAdapter.getProperty(r).getDescription()}catch(e){}var s=e["rdfs:comment"]?e["rdfs:comment"]:"",i="";return""!==t&&(""!==s&&(i+="<b>From Vocabulary:</b> "),i+=t),""!==s&&(""!==t&&(i+="<br><b>From Domain Specification:</b> "),i+=s),this.util.repairLinksInHTMLCode(i)}createExpectedTypes(e){var r=this.browser.sdoAdapter.getProperty(e["sh:path"]),t=this.util.prettyPrintIri(r.getIRI(!0));return e["sh:or"].map(e=>{var r;e["sh:datatype"]?r=e["sh:datatype"]:e["sh:class"]&&(r=e["sh:class"]);var s=this.dsHandler.dataTypeMapperFromSHACL(r);if(null!==s)return this.util.createLink(s);if(r=this.dsHandler.rangesToString(r),e["sh:node"]&&0!==e["sh:node"]["sh:property"].length){var i=t+"-"+r;return this.util.createJSLink("path",i,r,null,"-")}return this.util.createTermLink(r)}).join("<br>")}createEnumerationMembers(){var e=this.browser.sdoAdapter.getTerm(this.node["sh:class"]).getEnumerationMembers();return 0!==e.length?'An Enumeration with:<br><b><a id="enumbers" title="Link: #enumbers" href="#enumbers" class="clickableAnchor">Enumeration members</a></b><ul>'+e.map(e=>{var r=this.browser.sdoAdapter.getEnumerationMember(e);return"<li>"+this.util.createLink(r.getIRI(),e)+"</li>"}).join("")+"</ul><br>":""}}module.exports=NativeRenderer;

},{}],89:[function(require,module,exports){
"use strict";class TableRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer,this.clickHandler=null,this.changeInnerDSHandler=null}render(){var e=this.dsHandler.generateDsClass(this.browser.ds["@graph"][0],!1,!1),t=this.dsRenderer.createHeader()+this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.table)+'<div id="table-view"> '+this.dsRenderer.createVisBtnRow()+'<div id="table-wrapper"><table id="table-ds">'+this.createTableContent(e)+"</table></div></div>";this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",t),this.addClickEvent(),this.addChangeInnerDSEventListener()}createTableContent(e){return'<tr class="first-row-ds"><td><div class="align-items"><img src="" class="glyphicon glyphicon-list-alt">'+e.text+'</div></td><td colspan="2">'+e.data.dsDescription+"</td><td><b>Cardinality</b></td></tr>"+this.processProperties(e.children,0)}processProperties(e,t,s,n){return e.map((a,r)=>a.children&&0!==a.children.length&&!a.isEnum?this.processPropertyWithChildren(a,t,s):this.processPropertyWithNoChildren(a,t,s,n,e.length===r+1)).join("")}processPropertyWithChildren(e,t){var s,n="";if(++t<4){s="depth"+t+" innerTable";var a=e.data.dsRange.split(" or "),r=this.hasMultipleClasses(a),i=this.createDSRange(e,t,a,r),d=e.children;n+="<tr>"+this.createTdProperty(e)+'<td colspan="2" class="'+s+'"><table>'+this.createInnerTableHeader(i,e)+d.map((e,s)=>this.processProperties(e.children,t,s,r)).join("")+'</table></td><td class="cardinality">'+this.dsHandler.createCardinality(e.data.minCount,e.data.maxCount)+"</td></tr>"}else console.log("To many levels for table view. Level: "+t);return n}hasMultipleClasses(e){var t=0;for(var s of e)if(this.isClass(s)&&2===++t)return!0;return!1}isClass(e){var t=this.cleanTerm(e);return!["Text","Number","URL","Boolean"].includes(t)}createDSRange(e,t,s){var n=!1;return""+s.map((e,t)=>{var a=this.cleanTerm(e),r=this.isClass(a),i=t+1<s.length?"&nbsp;or  <br>":"",d=n&&r?' class="change-to-class"':"";return r?(n=!0,'<span class="align-items"><img src="" class="glyphicon glyphicon-list-alt"><b'+d+' data-innerdsindex="'+t+'">'+a+"</b>"+i+"</span>"):a+i}).join("")}cleanTerm(e){return e.replace("<strong>","").replace("</strong>","").replace(/ /g,"")}createTdProperty(e){return"<td"+(arguments.length>1&&void 0!==arguments[1]?arguments[1]:"")+'><div class="align-items"><img class="glyphicon glyphicon-tag '+(e.data.isOptional?"optional":"mandatory")+'-property" src="" />'+e.text+"</div></td>"}createInnerTableHeader(e,t){return'<tr><td data-innerdsindex="0">'+e+'</td><td colspan="2">'+t.data.dsDescription+"</td><td><b>Cardinality</b></td></tr>"}processPropertyWithNoChildren(e,t,s,n,a){var r=this.dsHandler.createCardinality(e.data.minCount,e.data.maxCount),i=a?' style="border-bottom: none !important;"':"";return'<tr data-innerdsindex="'+s+'"'+(0!==s&&n?' style="display: none;"':"")+">"+this.createTdProperty(e,i)+(e.isEnum?this.createEnum(e,t,i):this.createSimpleType(e,i))+'<td class="cardinality"'+i+">"+r+"</td></tr>"}createEnum(e,t,s){return'<td colspan="2" class="depth'+ ++t+' innerTable"'+s+'><table class="table enumTable"><tr><td class="enumTd"><b>'+e.data.dsRange+'</b></td><td class="enumTd">'+e.data.dsDescription+"</td></tr>"+(e.data.enuMembers?this.genHTML_enuMembers(e.data.enuMembers):"")+"</table></td>"}genHTML_enuMembers(e){return e.map(e=>'<tr><td class="enumTd">'+e.name+'</td><td class="enumTd">'+e.description+"</td></tr>").join("")}createSimpleType(e,t){return"<td"+t+">"+e.data.dsRange+"</td><td"+t+">"+e.data.dsDescription+"</td>"}addClickEvent(){var e=document.getElementById("table-view").getElementsByClassName("btn-vis-shadow")[0];this.clickHandler=this.clickEvent.bind(this),e.addEventListener("click",this.clickHandler,!0)}clickEvent(e){var t,s,n=e.target;n.removeEventListener("click",this.clickHandler,!0),n.classList.remove("btn-vis-shadow"),"btn-opt"===n.id?(t=document.getElementById("btn-man"),s=!0):(t=document.getElementById("btn-opt"),s=!1),t.classList.add("btn-vis-shadow");var a=this.dsHandler.generateDsClass(this.browser.ds["@graph"][0],!1,s),r=document.getElementById("table-ds");r.innerHTML=this.createTableContent(a),this.util.fade(r),this.addClickEvent(),this.addChangeInnerDSEventListener()}addChangeInnerDSEventListener(){var e=document.getElementById("table-view").getElementsByClassName("change-to-class");for(var t of(this.changeInnerDSHandler=this.changeInnerDSEvent.bind(this),e))t.addEventListener("click",this.changeInnerDSHandler,!0)}changeInnerDSEvent(e){for(var t=e.target,s=t.closest("tr"),n=t.dataset.innerdsindex;s.nextSibling;)(s=s.nextSibling).dataset.innerdsindex===n?(s.style.display="table-row",this.util.fade(s)):s.style.display="none";var a=t.closest("td").querySelector("b:not(.change-to-class)");a.classList.add("change-to-class"),a.addEventListener("click",this.changeInnerDSHandler,!0),t.classList.remove("change-to-class"),t.removeEventListener("click",this.changeInnerDSHandler,!0)}}module.exports=TableRenderer;

},{}],90:[function(require,module,exports){
"use strict";class TreeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){var e=""+this.dsRenderer.createHeader()+this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.tree)+'<div id="div-iframe"><iframe id="iframe-jsTree" frameborder="0" width="100%" scrolling="no"></iframe></div>';this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",e),this.initIFrameForJSTree()}initIFrameForJSTree(){this.iFrame=document.getElementById("iframe-jsTree"),this.iFrameCW=this.iFrame.contentWindow;var e=this.iFrameCW.document,r=this.createJSTreeHTML();e.open(),e.write(r),e.close();var t=this.dsHandler.generateDsClass(this.browser.ds["@graph"][0],!1,!1);this.mapNodeForJSTree([t])}createJSTreeHTML(){return'<head><script src="https://code.jquery.com/jquery-3.5.1.min.js"   integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"><\/script><script src="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.10/jstree.min.js"><\/script><script src="https://cdnjs.cloudflare.com/ajax/libs/jstreegrid/3.10.2/jstreegrid.min.js"><\/script><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" /><link rel="stylesheet"   href="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.10/themes/default/style.min.css" />'+this.createTreeStyle()+"</head><body>"+this.dsRenderer.createVisBtnRow()+'<div id="jsTree"></div></body>'}createTreeStyle(){return"<style>.optional-property { color: #ffa517; }.mandatory-property { color: #00ce0c; }#btn-row { padding: 12px 0px 12px 5px; }.btn-vis { padding: 5px; }.btn-vis-shadow {    cursor: pointer;    webkit-box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.2);    box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.2);}</style>"}mapNodeForJSTree(e){var r=this;this.iFrame.addEventListener("load",function(){r.iFrameCW.$("#jsTree").jstree({plugins:["grid"],core:{themes:{icons:!0,dots:!0,responsive:!0,stripes:!0,rootVisible:!1},data:e},grid:{columns:[{width:"20%",header:"Class / Property"},{header:"Range / Type",width:"20%",value:function(e){return e.data.dsRange}},{width:"40%",header:"Description",value:function(e){return e.data.dsDescription}},{width:"20%",header:"Cardinality",value:function(e){if(e.data.dsRange)return r.dsHandler.createCardinality(e.data.minCount,e.data.maxCount)}}]}}).bind("ready.jstree after_open.jstree after_close.jstree refresh.jstree",r.adaptIframe.bind(r)),r.addIframeClickEvent()})}adaptIframe(){var e=window.scrollY,r=window.scrollX;this.iFrame.height="0px",this.iFrame.height=this.iFrameCW.document.body.scrollHeight,window.scrollTo(r,e)}addIframeClickEvent(){this.iFrameCW.$(".btn-vis-shadow").click(e=>{var r,t,s=this.iFrameCW.$(e.currentTarget);s.removeClass("btn-vis-shadow"),"btn-opt"===s.attr("id")?(r=this.iFrameCW.$("#btn-man"),t=!0):(r=this.iFrameCW.$("#btn-opt"),t=!1),r.addClass("btn-vis-shadow"),s.off("click"),this.addIframeClickEvent();var i=this.dsHandler.generateDsClass(this.browser.ds["@graph"][0],!1,t),a=this.iFrameCW.$("#jsTree").jstree(!0);a.settings.core.data=i,a.refresh()})}}module.exports=TreeRenderer;

},{}],91:[function(require,module,exports){
"use strict";function asyncGeneratorStep(t,e,r,n,a,i,s){try{var o=t[i](s),l=o.value}catch(t){return void r(t)}o.done?e(l):Promise.resolve(l).then(n,a)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(n,a){var i=t.apply(e,r);function s(t){asyncGeneratorStep(i,n,a,s,o,"next",t)}function o(t){asyncGeneratorStep(i,n,a,s,o,"throw",t)}s(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJson(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJson(t){return new Promise(function(e,r){var n=new XMLHttpRequest;n.open("GET",t),n.setRequestHeader("Accept","application/json"),n.onload=function(){this.status>=200&&this.status<300?e(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}repairLinksInHTMLCode(t){return t.replace(/<a(.*?)href="(.*?)"/g,(t,e,r)=>{return r.startsWith("/")&&(r="http://schema.org"+r),"<a"+e+'href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank"'})}createIriWithQueryParam(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URLSearchParams(window.location.search);if(e&&""!==e){var a=n.get(t);null!==a&&r?n.set(t,a+r+e):n.set(t,e)}else n.delete(t);var i=n.toString();return window.location.protocol+"//"+(window.location.host?window.location.host:"")+window.location.pathname+(""!==i?"?"+i:"")}createJSLink(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,i=this.createIriWithQueryParam(t,e,a);return'<a class="a-js-link" href="'+this.escHtml(i)+'" onclick="return false;"'+this.createHtmlAttr(n)+">"+(r?this.escHtml(r):this.escHtml(e))+"</a>"}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URL(t);if(window.location.hostname!==n.hostname){var a=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+a:r.style=a:r={style:a},r.target="_blank"}return'<a href="'+this.escHtml(t)+'"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right; background-repeat: no-repeat; background-size: 10px 10px; padding-right: 13px; ";return/^https?:\/\/schema.org/.test(t)?e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-red.png);":e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-blue.png);",e}createTableRow(t,e,r,n,a){var i=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null;return'<tr typeof="'+t+'" resource="'+e+'">'+this.createMainCol(r,n,i)+a+"</tr>"}createMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(e,{property:t})+"</th>"}createCodeLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return"<code"+this.createHtmlAttr(e)+">"+t+"</code>"}createDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]),'<table class="table definition-table"'+this.createHtmlAttr(r)+"><thead><tr>"+t.map(t=>"<th>"+t+"</th>").join("")+"</tr></thead><tbody"+this.createHtmlAttr(n)+">"+(e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join(""))+"</tbody></table>"}createMainContent(t,e){return'\n            <div>\n                <div id="mainContent" vocab="http://schema.org/" typeof="'.concat(t,'" resource="').concat(window.location,'">\n                    ').concat(e,"\n                </div>\n            </div>")}createExternalLinkLegend(){return'<p style="font-size: 12px; margin-top: 0">(<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle(""))+'"></span>External link<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle("http://schema.org")+" margin-left: 6px;")+'"></span>External link to schema.org )</p>'}createTermLink(t){var e,r=this.browser.sdoAdapter.getTerm(t),n=r.getVocabURLs();if(n)for(var a of n)if(/http(s)?:\/\/(staging\.)?semantify\.it\/voc\//.test(a)){e=a+"?term="+t;break}return e=e||r.getIRI(),this.createLink(e,r.getIRI(!0))}prettyPrintClassDefinition(t){return Array.isArray(t)?t.map(t=>this.prettyPrintIri(t)).join(", "):this.prettyPrintIri(t)}fade(t){var e=.05,r=setInterval(()=>{e>=1&&clearInterval(r),t.style.opacity=e,t.style.filter="alpha(opacity="+100*e+")",e+=.05*e},10)}}module.exports=Util;
