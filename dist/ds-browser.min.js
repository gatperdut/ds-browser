...
"use strict";var _schemaOrgAdapter=_interopRequireDefault(require("schema-org-adapter")),_Util=_interopRequireDefault(require("./Util")),_DSHandler=_interopRequireDefault(require("./DSHandler")),_ListRenderer=_interopRequireDefault(require("./ListRenderer")),_DSRenderer=_interopRequireDefault(require("./DSRenderer")),_NativeRenderer=_interopRequireDefault(require("./NativeRenderer")),_TreeRenderer=_interopRequireDefault(require("./TreeRenderer")),_TableRenderer=_interopRequireDefault(require("./TableRenderer")),_SHACLRenderer=_interopRequireDefault(require("./SHACLRenderer"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,r,i,n,s,d){try{var a=e[s](d),o=a.value}catch(e){return void r(e)}a.done?t(o):Promise.resolve(o).then(i,n)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(i,n){var s=e.apply(t,r);function d(e){asyncGeneratorStep(s,i,n,d,a,"next",e)}function a(e){asyncGeneratorStep(s,i,n,d,a,"throw",e)}d(void 0)})}}class DSBrowser{constructor(e){var t=this;this.util=new _Util.default(this),this.dsHandler=new _DSHandler.default(this),this.listRenderer=new _ListRenderer.default(this),this.dsRenderer=new _DSRenderer.default(this),this.nativeRenderer=new _NativeRenderer.default(this),this.treeRenderer=new _TreeRenderer.default(this),this.tableRenderer=new _TableRenderer.default(this),this.shaclRenderer=new _SHACLRenderer.default(this),this.targetElement=e.targetElement,this.locationControl=!1!==e.locationControl,this.locationControl?this.readStateFromUrl():(this.listId=e.listId||null,this.dsId=e.dsId||null,this.path=e.path||null,this.viewMode=e.viewMode||null,this.format=e.format||null),this.locationControl&&window.addEventListener("popstate",_asyncToGenerator(function*(){t.readStateFromUrl(),yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){e.targetElement.innerHTML=e.util.createHtmlLoading(),yield e.renderInit(),"shacl"===e.format?e.shaclRenderer.renderSHACL():e.dsId&&"tree"!==e.viewMode&&"table"!==e.viewMode?e.nativeRenderer.render():e.dsId&&"tree"===e.viewMode?e.treeRenderer.render():e.dsId&&"table"===e.viewMode?e.tableRenderer.render():e.listId?e.listRenderer.render():console.error("Input parameters invalid."),e.addJSLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0})()}renderInit(){var e=this;return _asyncToGenerator(function*(){!e.listId||e.list&&e.list["@id"].endsWith(e.listId)||(yield e.initList()),!e.dsId||e.ds&&e.ds["@id"].endsWith(e.dsId)||(yield e.initDS()),e.ds&&(e.dsRootNode=e.util.discoverDsRootNode(e.ds["@graph"]),e.dsNode=e.dsHandler.getDSNodeForPath())})()}initList(){var e=this;return _asyncToGenerator(function*(){e.list=yield e.util.parseToObject("https://semantify.it/list/"+e.listId+"?representation=lean")})()}initDS(){var e=this;return _asyncToGenerator(function*(){e.ds=yield e.util.parseToObject("https://semantify.it/ds/"+e.dsId),e.sdoAdapter=new _schemaOrgAdapter.default;var t=yield e.getVocabUrlsForDS();yield e.sdoAdapter.addVocabularies(t)})()}getVocabUrlsForDS(){var e=this;return _asyncToGenerator(function*(){if(!e.ds)return[];var t=[],r=e.util.discoverDsRootNode(e.ds["@graph"]);if(r&&Array.isArray(r["ds:usedVocabularies"])&&(t=r["ds:usedVocabularies"]),r&&r["schema:schemaVersion"]){var i=e.getSDOVersion(r["schema:schemaVersion"]);t.push(yield e.sdoAdapter.constructSDOVocabularyURL(i))}return t})()}getSDOVersion(e){return/.*schema\.org\/version\/([0-9.]+)\//g.exec(e)[1]}addJSLinkEventListener(){var e=this,t=this.targetElement.getElementsByClassName("a-js-link"),r=function(t){t.addEventListener("click",function(){var r=_asyncToGenerator(function*(r){e.locationControl?r.ctrlKey?window.open(t.href):(history.pushState(null,null,t.href),e.navigate(JSON.parse(decodeURIComponent(t.getAttribute("data-state-changes"))))):e.navigate(JSON.parse(decodeURIComponent(t.getAttribute("data-state-changes"))))});return function(e){return r.apply(this,arguments)}}())};for(var i of t)r(i)}readStateFromUrl(){var e=new URLSearchParams(window.location.search);if(this.path=e.get("path")||null,this.format=e.get("format")||null,this.viewMode=e.get("mode")||null,window.location.pathname.includes("/ds/")){this.listId=null;var t=window.location.pathname.substring("/ds/".length);this.dsId!==t&&(this.dsId=t,this.ds=null)}else if(window.location.pathname.includes("/list/")){var r=window.location.pathname.substring("/list/".length);this.listId!==r&&(this.listId=r,this.list=null);var i=e.get("ds")||null;this.dsId!==i&&(this.dsId=i,this.ds=null)}else this.listId=null,this.list=null,this.dsId=null,this.ds=null}navigate(e){console.log(e),void 0!==e.listId&&(this.listId=e.listId),void 0!==e.dsId&&(this.dsId=e.dsId),void 0!==e.path&&(this.path=e.path),void 0!==e.viewMode&&(this.viewMode=e.viewMode),void 0!==e.format&&(this.format=e.format),null===this.listId&&(this.list=void 0),null===this.dsId&&(this.ds=void 0),this.ds||(this.path=null),this.render()}}module.exports=DSBrowser;
...
"use strict";class DSHandler{constructor(t){this.browser=t,this.util=t.util}getDSNodeForPath(){var t=this.browser.dsRootNode,e={type:"",node:{}};if(t)if(this.browser.path){for(var r=this.browser.path.split("-"),s=0;s<r.length;s++)""!==r[s]&&(r[s].charAt(0).toUpperCase()===r[s].charAt(0)?null!==t&&(t=this.getClass(t["sh:or"],r[s])):null!==t&&s!==r.length-1&&(t=void 0!==t["sh:targetClass"]?this.getProperty(t["sh:property"],r[s]):this.getProperty(t["sh:node"]["sh:property"],r[s])));if(t&&t["sh:class"]&&!Array.isArray(t["sh:class"]))try{this.browser.sdoAdapter.getEnumeration(t["sh:class"]),e.type="Enumeration"}catch(t){e.type="Class"}else e.type="Class"}else e.type="Class";else e.type="error";return e.node=t,e}getClass(t,e){return t.find(t=>t["sh:class"]&&this.rangesToString(t["sh:class"])===e)||null}getProperty(t,e){return t.find(t=>this.rangesToString(t["sh:path"])===e)||null}dataTypeMapperFromSHACL(t){switch(t){case"xsd:string":return"http://schema.org/Text";case"xsd:boolean":return"http://schema.org/Boolean";case"xsd:date":return"http://schema.org/Date";case"xsd:dateTime":return"http://schema.org/DateTime";case"xsd:time":return"http://schema.org/Time";case"xsd:double":return"http://schema.org/Number";case"xsd:float":return"http://schema.org/Float";case"xsd:integer":return"http://schema.org/Integer";case"xsd:anyURI":return"http://schema.org/URL"}return null}rangesToString(t){return Array.isArray(t)?t.map(t=>this.util.prettyPrintIri(t)).join(" + "):this.util.prettyPrintIri(t)}createHtmlCardinality(t,e){var r,s="";return t&&0!==t?e&&0!==e?t!==e?(r="This property is required. It must have between "+t+" and "+e+" value(s).",s=t+".."+e):(r="This property is required. It must have "+t+" value(s).",s=t):(r="This property is required. It must have at least "+t+" value(s).",s=t+"..N"):e&&0!==e?(r="This property is optional. It must have at most "+e+" value(s).",s="0.."+e):(r="This property is optional. It may have any amount of values.",s="0..N"),'<span title="'.concat(r,'">').concat(s,"</span>")}generateDsClass(t,e,r){var s,a={},i=t["sh:targetClass"];a.text=i?this.util.prettyPrintClassDefinition(i):this.util.prettyPrintClassDefinition(t["sh:class"]),a.icon="glyphicon glyphicon-list-alt",e||(a.state={opened:!0});try{s=-1===a.text.indexOf(",")?this.browser.sdoAdapter.getClass(a.text).getDescription():"No description found."}catch(t){s="No description found."}return a.data={},a.data.dsDescription=s,t["rdfs:comment"]&&(a.justification=t["rdfs:comment"]),a.children=this.processChildren(t,r),a}processChildren(t,e){var r,s=[],a=t["sh:property"],i=t["sh:node"];return a?r=a:i&&i["sh:property"]&&(r=i["sh:property"]),void 0!==r&&r.forEach(t=>{var r=this.generateDsProperty(t,e);r&&s.push(r)}),s}generateDsProperty(t,e){var r={};return r.justification=t["rdfs:comment"],r.text=this.util.prettyPrintIri(t["sh:path"]),r.data={},r.data.minCount=t["sh:minCount"],r.data.maxCount=t["sh:maxCount"],r.children=[],this.processEnum(r,t["sh:or"][0]),this.processVisibility(r,t["sh:minCount"]),this.processExpectedTypes(r,t["sh:or"],e),e?r:r.data.isOptional?null:r}processEnum(t,e){var r;t.isEnum=!1;try{var s=e["sh:class"];r=this.browser.sdoAdapter.getEnumeration(s),t.isEnum=!0}catch(t){}if(t.isEnum){var a=this.getEnumMemberArray(e["sh:in"],r);a.forEach(t=>{var e=this.browser.sdoAdapter.getEnumerationMember(t.name);t.description=this.util.repairLinksInHTMLCode(e.getDescription())}),t.data.enuMembers=a,t.children=a.map(t=>({children:[],data:{dsRange:"",dsDescription:this.util.repairLinksInHTMLCode(t.description)},icon:"glyphicon glyphicon-chevron-right",text:t.name}))}}getEnumMemberArray(t,e){return t?t.map(t=>{var e=t["@id"];return{name:e=e.replace("schema:","")}}):e.getEnumerationMembers().map(t=>({name:t}))}processVisibility(t,e){t.icon="glyphicon glyphicon-tag",!e>0?(t.icon+=" optional-property",t.data.isOptional=!0):(t.icon+=" mandatory-property",t.data.isOptional=!1)}processExpectedTypes(t,e,r){var s=!1;if(e){var a=this.generateDsRange(e);t.data.dsRange=a.rangeAsString,t.data.rangeJustification=a.rangeJustification;try{var i=this.browser.sdoAdapter.getProperty(t.text).getDescription();t.data.dsDescription=this.util.repairLinksInHTMLCode(i)}catch(e){t.data.dsDescription="No description found."}e.forEach(e=>{if(e["sh:node"]){s=!0;var a=this.generateDsClass(e,!0,r);t.children.push(a)}})}s&&(t.state={opened:!0})}generateDsRange(t){var e={rangeAsString:"",rangeJustification:[]};return e.rangeAsString=t.map(t=>{var r,s,a={},i=t["sh:datatype"],n=t["sh:class"];return s=i?r=this.util.prettyPrintIri(this.dataTypeMapperFromSHACL(i)):t["sh:node"]?"<strong>"+(r=this.util.prettyPrintClassDefinition(n))+"</strong>":r=this.util.prettyPrintClassDefinition(n),a.name=r,a.justification=t["rdfs:comment"],e.rangeJustification.push(a),s}).join(" or "),e}}module.exports=DSHandler;

},{}],80:[function(require,module,exports){
"use strict";function _defineProperty(e,t,i){return t in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}class DSRenderer{constructor(e){_defineProperty(this,"MODES",{native:"native",tree:"tree",table:"table"}),this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler}createViewModeSelectors(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this.MODES.native;return'<div class="ds-selector-tabs ds-selector"><div class="selectors">'+(e===this.MODES.native?'<a class="selected">Native View</a>':this.util.createInternalLink({viewMode:null},"Native View"))+(e===this.MODES.tree?'<a class="selected">Tree View</a>':this.util.createInternalLink({viewMode:"tree"},"Tree View"))+(e===this.MODES.table?'<a class="selected">Table View</a>':this.util.createInternalLink({viewMode:"table"},"Table View"))+"</div></div>"}createHtmlHeader(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e,t,i="";if(this.browser.path){var r=this.node["sh:class"];e=this.dsHandler.rangesToString(r),t=this.createNodeDescription(r),i=this.createBreadcrumbs()}else{var s=this.browser.ds["@graph"][0];e=s["schema:name"]||"Domain Specification",t=s["schema:description"]||""}return t=this.util.repairLinksInHTMLCode(t),this.createNavigation()+'<h1 property="schema:name">'+e+"</h1>"+this.util.createHtmlExternalLinkLegend()+i+'<div property="schema:description">'+t+"<br><br></div>"}createNodeDescription(e){return this.util.isString(e)?this.browser.sdoAdapter.getTerm(e).getDescription():e.map(e=>"<b>"+this.util.prettyPrintIri(e)+":</b> "+this.browser.sdoAdapter.getTerm(e).getDescription()).join("<br>")}createBreadcrumbs(){var e=this.util.createInternalLink({path:null},this.browser.dsRootNode["schema:name"]||"Domain Specification"),t=this.browser.path.split("-").map((e,t,i)=>{if(t%2==0)return e;var r=i.slice(0,t+1).join("-");return this.util.createInternalLink({path:r},e)}).join(" > ");return'<h4><span class="breadcrumbs">\n            '.concat(e," > ").concat(t,"\n            </span></h4>")}createNavigation(){var e,t=this.browser.dsId;e=this.browser.locationControl?this.util.createInternalLink({format:"shacl"},"SHACL serialization"):'<a href="https://semantify.it/ds/'.concat(t,'?format=shacl" target="_blank">SHACL serialization</a>');var i=this.browser.list?" | from List: "+this.util.createInternalLink({dsId:null},this.browser.list["schema:name"]):"";return'<span style="float: right;">('.concat(e).concat(i,")</span>")}createVisBtnRow(){return'<div id="btn-row">Show: \n            <span id="btn-opt" class="btn-vis btn-vis-shadow" style="margin-left: 10px;">\n                <img src="" class="glyphicon glyphicon-tag optional-property"> optional\n            </span>\n            <span id="btn-man" class="btn-vis" style="margin-left: 10px;">\n                <img src="" class="glyphicon glyphicon-tag mandatory-property"> mandatory\n            </span></div>'}}module.exports=DSRenderer;

},{}],81:[function(require,module,exports){
"use strict";class ListRenderer{constructor(t){this.browser=t,this.util=t.util}render(){var t=this.createHtmlHeader()+this.createHtmlDsTable();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("schema:DataSet",t)}createHtmlHeader(){var t=this.browser.list["schema:name"]||"",e=this.util.createHtmlExternalLinkLegend(),r=this.browser.list["schema:description"]||"";return"<h1>".concat(t,"</h1>\n            ").concat(e,"\n            ").concat(r)}createHtmlDsTable(){return this.util.createHtmlDefinitionTable(["Name","IRI","Description"],this.createHtmlDsTbody(),null,{class:"supertype"})}createHtmlDsTbody(){return this.browser.list["schema:hasPart"].map(t=>this.util.createHtmlTableRow("http://vocab.sti2.at/ds/Domain Specification",t["@id"],"schema:name",this.util.createInternalLink({dsId:t["@id"].split("/").pop()},t["schema:name"]||"No Name"),this.createHtmlDsSideCols(t))).join("")}createHtmlDsSideCols(t){var e=this.util.createLink(t["@id"]),r=t["schema:description"]||"";return'<td property="@id">'.concat(e,'</td>\n            <td property="schema:description">').concat(r,"</td>")}}module.exports=ListRenderer;

},{}],82:[function(require,module,exports){
"use strict";class NativeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){this.dsNode=this.browser.dsNode,this.node=this.dsNode.node;var e=this.dsRenderer.createHtmlHeader()+this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.native)+("Class"===this.dsNode.type?this.createHtmlPropertiesTable():this.createEnumerationMembers());this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",e)}createHtmlPropertiesTable(){var e=(this.browser.path?this.node["sh:node"]["sh:property"].slice(0):this.node["sh:property"].slice(0)).map(e=>this.createClassProperty(e)).join("");return this.util.createHtmlDefinitionTable(["Property","Expected Type","Description","Cardinality"],e,{style:"margin-top: 0px; border-top: none;"})}createClassProperty(e){var t=e["sh:path"],r=this.browser.sdoAdapter.getProperty(t);return this.util.createHtmlTableRow("rdf:Property",r.getIRI(),"rdfs:label",this.util.createTermLink(t),this.createClassPropertySideCols(e),"prop-name")}createClassPropertySideCols(e){var t=this.createHtmlExpectedTypes(e),r=this.createHtmlPropertyDescription(e),s=this.dsHandler.createHtmlCardinality(e["sh:minCount"],e["sh:minCount"]);return'<td class="prop-ect">'.concat(t,'</td>\n            <td class="prop-desc">').concat(r,'</td>\n            <td class="prop-ect">').concat(s,"</td>")}createHtmlPropertyDescription(e){var t,r=this.util.prettyPrintIri(e["sh:path"]);try{t=this.browser.sdoAdapter.getProperty(r).getDescription()}catch(e){t=""}var s=e["rdfs:comment"]?e["rdfs:comment"]:"",i="";return""!==t&&(""!==s&&(i+="<b>From Vocabulary:</b> "),i+=t),""!==s&&(""!==t&&(i+="<br><b>From Domain Specification:</b> "),i+=s),this.util.repairLinksInHTMLCode(i)}createHtmlExpectedTypes(e){var t=this.browser.sdoAdapter.getProperty(e["sh:path"]),r=this.util.prettyPrintIri(t.getIRI(!0));return e["sh:or"].map(e=>{var t;e["sh:datatype"]?t=e["sh:datatype"]:e["sh:class"]&&(t=e["sh:class"]);var s=this.dsHandler.dataTypeMapperFromSHACL(t);if(null!==s)return this.util.createLink(s);if(t=this.dsHandler.rangesToString(t),e["sh:node"]&&0!==e["sh:node"]["sh:property"].length){var i=this.browser.path?this.browser.path+"-"+r+"-"+t:r+"-"+t;return this.util.createInternalLink({path:i},t)}return this.util.createTermLink(t)}).join("<br>")}createEnumerationMembers(){var e=this.browser.sdoAdapter.getTerm(this.node["sh:class"]).getEnumerationMembers();if(0!==e.length){var t=e.map(e=>{var t=this.browser.sdoAdapter.getEnumerationMember(e);return"<li>"+this.util.createLink(t.getIRI(),e)+"</li>"}).join("");return'An Enumeration with:<br>\n                <b><a id="enumbers" title="Link: #enumbers" href="#enumbers" class="clickableAnchor">Enumeration members</a></b>\n                <ul>'.concat(t,"</ul><br>")}return""}}module.exports=NativeRenderer;

},{}],83:[function(require,module,exports){
"use strict";class SHACLRenderer{constructor(e){this.browser=e}renderSHACL(){this.browser.targetElement.innerHTML=this.createHtmlShacl(JSON.stringify(this.browser.ds,null,2))}createHtmlShacl(e){return'<pre style="font-size: medium; /* Overwrite schema.org CSS */\n            background: none;\n            text-align: left;\n            width: auto;\n            padding: 0;\n            overflow: visible;\n            color: rgb(0, 0, 0);\n            line-height: normal;\n            display: block;     /* Defaults for pre https://www.w3schools.com/cssref/css_default_values.asp */\n            font-family: monospace;\n            margin: 1em 0;\n            word-wrap: break-word;  /* From Browser when loading SHACL file */\n            white-space: pre-wrap;'+'">'.concat(e,"</pre>")}}module.exports=SHACLRenderer;

},{}],84:[function(require,module,exports){
"use strict";class TableRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer,this.clickHandler=null,this.changeInnerDSHandler=null}render(){var e=this.dsHandler.generateDsClass(this.browser.dsRootNode,!1,!1),t=this.createHtmlTableContent(e),n=this.dsRenderer.createHtmlHeader(),a=this.dsRenderer.createVisBtnRow(),r=this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.table),s="".concat(n).concat(r,'\n            <div id="table-view">\n            ').concat(a,'\n            <div id="table-wrapper">\n            <table id="table-ds">').concat(t,"</table>\n            </div></div>");this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",s),this.addClickEvent(),this.addChangeInnerDSEventListener()}createHtmlTableContent(e){var t=e.text,n=e.data.dsDescription,a=this.createHtmlProperties(e.children,0);return'<tr class="first-row-ds">\n            <td><div class="align-items"><img src="" class="glyphicon glyphicon-list-alt">'.concat(t,'</div></td>\n            <td colspan="2">').concat(n,"</td>\n            <td><b>Cardinality</b></td></tr>\n            ").concat(a)}createHtmlProperties(e,t,n,a){return e.map((r,s)=>r.children&&0!==r.children.length&&!r.isEnum?this.createHtmlPropertyWithChildren(r,t,n):this.createHtmlPropertyWithNoChildren(r,t,n,a,e.length===s+1)).join("")}createHtmlPropertyWithChildren(e,t){var n,a="";if(++t<4){n="depth"+t+" innerTable";var r=e.data.dsRange.split(" or "),s=this.hasMultipleClasses(r),i=this.createDSRange(e,t,r,s),l=e.children;a+="<tr>"+this.createHtmlPropertyTdTag(e)+'<td colspan="2" class="'+n+'"><table>'+this.createInnerTableHeader(i,e)+l.map((e,n)=>this.createHtmlProperties(e.children,t,n,s)).join("")+'</table></td><td class="cardinality">'+this.dsHandler.createHtmlCardinality(e.data.minCount,e.data.maxCount)+"</td></tr>"}else console.log("To many levels for table view. Level: "+t);return a}hasMultipleClasses(e){var t=0;for(var n of e)if(this.isClass(n)&&2===++t)return!0;return!1}isClass(e){var t=this.cleanTerm(e);return!["Text","Number","URL","Boolean"].includes(t)}createDSRange(e,t,n){var a=!1;return""+n.map((e,t)=>{var r=this.cleanTerm(e),s=this.isClass(r),i=t+1<n.length?"&nbsp;or  <br>":"",l=a&&s?' class="change-to-class"':"";return s?(a=!0,'<span class="align-items"><img src="" class="glyphicon glyphicon-list-alt"><b'+l+' data-innerdsindex="'+t+'">'+r+"</b>"+i+"</span>"):r+i}).join("")}cleanTerm(e){return e.replace("<strong>","").replace("</strong>","").replace(/ /g,"")}createHtmlPropertyTdTag(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"",n=e.data.isOptional?"optional":"mandatory",a=e.text;return"<td".concat(t,'><div class="align-items">\n            <img class="glyphicon glyphicon-tag ').concat(n,'-property" src="" />').concat(a,"</div>\n            </td>")}createInnerTableHeader(e,t){var n=t.data.dsDescription;return'<tr><td data-innerdsindex="0">'.concat(e,'</td>\n            <td colspan="2">').concat(n,"</td>\n            <td><b>Cardinality</b></td></tr>")}createHtmlPropertyWithNoChildren(e,t,n,a,r){var s=this.dsHandler.createHtmlCardinality(e.data.minCount,e.data.maxCount),i=0!==n&&a?' style="display: none;"':"",l=r?' style="border-bottom: none !important;"':"",d=this.createHtmlPropertyTdTag(e,l),c=e.isEnum?this.createHtmlEnum(e,t,l):this.createHtmlSimpleType(e,l);return'<tr data-innerdsindex="'.concat(n,'" ').concat(i,">\n            ").concat(d).concat(c,'\n            <td class="cardinality" ').concat(l,">").concat(s,"</td></tr>")}createHtmlEnum(e,t,n){var a=e.data.dsRange,r=e.data.dsDescription,s=e.data.enuMembers?this.createHtmlEnumMembers(e.data.enuMembers):"";return'<td colspan="2" class="depth'.concat(++t,' innerTable" ').concat(n,'>\n            <table class="table enumTable"><tr>\n            <td class="enumTd"><b>').concat(a,'</b></td>\n            <td class="enumTd">').concat(r,"</td>\n            </tr>").concat(s,"</table></td>")}createHtmlEnumMembers(e){return e.map(e=>{var t=e.name,n=e.description;return'<tr>\n                <td class="enumTd">'.concat(t,'</td>\n                <td class="enumTd">').concat(n,"</td>\n                </tr>")}).join("")}createHtmlSimpleType(e,t){var n=e.data.dsRange,a=e.data.dsDescription;return"<td ".concat(t,">").concat(n,"</td>\n            <td ").concat(t,">").concat(a,"</td>")}addClickEvent(){var e=document.getElementById("table-view").getElementsByClassName("btn-vis-shadow")[0];this.clickHandler=this.clickEvent.bind(this),e.addEventListener("click",this.clickHandler,!0)}clickEvent(e){var t,n,a=e.target;a.removeEventListener("click",this.clickHandler,!0),a.classList.remove("btn-vis-shadow"),"btn-opt"===a.id?(t=document.getElementById("btn-man"),n=!0):(t=document.getElementById("btn-opt"),n=!1),t.classList.add("btn-vis-shadow");var r=this.dsHandler.generateDsClass(this.browser.dsRootNode,!1,n),s=document.getElementById("table-ds");s.innerHTML=this.createHtmlTableContent(r),this.util.fade(s),this.addClickEvent(),this.addChangeInnerDSEventListener()}addChangeInnerDSEventListener(){var e=document.getElementById("table-view").getElementsByClassName("change-to-class");for(var t of(this.changeInnerDSHandler=this.changeInnerDSEvent.bind(this),e))t.addEventListener("click",this.changeInnerDSHandler,!0)}changeInnerDSEvent(e){for(var t=e.target,n=t.closest("tr"),a=t.dataset.innerdsindex;n.nextSibling;)(n=n.nextSibling).dataset.innerdsindex===a?(n.style.display="table-row",this.util.fade(n)):n.style.display="none";var r=t.closest("td").querySelector("b:not(.change-to-class)");r.classList.add("change-to-class"),r.addEventListener("click",this.changeInnerDSHandler,!0),t.classList.remove("change-to-class"),t.removeEventListener("click",this.changeInnerDSHandler,!0)}}module.exports=TableRenderer;

},{}],85:[function(require,module,exports){
"use strict";class TreeRenderer{constructor(e){this.browser=e,this.util=e.util,this.dsHandler=e.dsHandler,this.dsRenderer=e.dsRenderer}render(){var e=this.dsRenderer.createHtmlHeader(),r=this.dsRenderer.createViewModeSelectors(this.dsRenderer.MODES.tree),t="".concat(e,"\n            ").concat(r,'\n            <div id="div-iframe">\n            <iframe id="iframe-jsTree" frameborder="0" width="100%" scrolling="no"></iframe>\n            </div>');this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",t),this.initIFrameForJSTree()}initIFrameForJSTree(){this.iFrame=document.getElementById("iframe-jsTree"),this.iFrameCW=this.iFrame.contentWindow;var e=this.iFrameCW.document,r=this.createJSTreeHTML();e.open(),e.write(r),e.close();var t=this.dsHandler.generateDsClass(this.browser.dsRootNode,!1,!1);this.mapNodeForJSTree([t])}createJSTreeHTML(){var e=this.dsRenderer.createVisBtnRow(),r=this.createTreeStyle();return'<head>\n            <script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"><\/script>\n            <script src="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.10/jstree.min.js"><\/script>\n            <script src="https://cdnjs.cloudflare.com/ajax/libs/jstreegrid/3.10.2/jstreegrid.min.js"><\/script>\n            <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" />\n            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.10/themes/default/style.min.css" />\n            '.concat(r,"\n            </head>\n            <body>").concat(e,'<div id="jsTree"></div></body>')}createTreeStyle(){return"<style>\n            .optional-property { color: #ffa517; }\n            .mandatory-property { color: #00ce0c; }\n            #btn-row { padding: 12px 0px 12px 5px; }\n            .btn-vis { padding: 5px; }\n            .btn-vis-shadow {\n                cursor: pointer;\n                webkit-box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.2);\n                box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.2);\n            }\n            </style>"}mapNodeForJSTree(e){var r=this;this.iFrame.addEventListener("load",function(){r.iFrameCW.$("#jsTree").jstree({plugins:["grid"],core:{themes:{icons:!0,dots:!0,responsive:!0,stripes:!0,rootVisible:!1},data:e},grid:{columns:[{width:"20%",header:"Class / Property"},{header:"Range / Type",width:"20%",value:function(e){return e.data.dsRange}},{width:"40%",header:"Description",value:function(e){return e.data.dsDescription}},{width:"20%",header:"Cardinality",value:function(e){if(e.data.dsRange)return r.dsHandler.createHtmlCardinality(e.data.minCount,e.data.maxCount)}}]}}).bind("ready.jstree after_open.jstree after_close.jstree refresh.jstree",r.adaptIframe.bind(r)),r.addIframeClickEvent()})}adaptIframe(){var e=window.scrollY,r=window.scrollX;this.iFrame.height="0px",this.iFrame.height=this.iFrameCW.document.body.scrollHeight,window.scrollTo(r,e)}addIframeClickEvent(){this.iFrameCW.$(".btn-vis-shadow").click(e=>{var r,t,s=this.iFrameCW.$(e.currentTarget);s.removeClass("btn-vis-shadow"),"btn-opt"===s.attr("id")?(r=this.iFrameCW.$("#btn-man"),t=!0):(r=this.iFrameCW.$("#btn-opt"),t=!1),r.addClass("btn-vis-shadow"),s.off("click"),this.addIframeClickEvent();var i=this.dsHandler.generateDsClass(this.browser.dsRootNode,!1,t),a=this.iFrameCW.$("#jsTree").jstree(!0);a.settings.core.data=i,a.refresh()})}}module.exports=TreeRenderer;

},{}],86:[function(require,module,exports){
"use strict";function asyncGeneratorStep(t,e,r,n,a,i,s){try{var o=t[i](s),c=o.value}catch(t){return void r(t)}o.done?e(c):Promise.resolve(c).then(n,a)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(n,a){var i=t.apply(e,r);function s(t){asyncGeneratorStep(i,n,a,s,o,"next",t)}function o(t){asyncGeneratorStep(i,n,a,s,o,"throw",t)}s(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJson(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJson(t){return new Promise(function(e,r){var n=new XMLHttpRequest;n.open("GET",t),n.setRequestHeader("Accept","application/json"),n.onload=function(){this.status>=200&&this.status<300?e(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}repairLinksInHTMLCode(t){return t.replace(/<a(.*?)href="(.*?)"/g,(t,e,r)=>{return r.startsWith("/")&&(r="http://schema.org"+r),"<a"+e+'href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank"'})}createInternalLink(t,e){e=this.escHtml(e);var r=this.browser.locationControl?this.createInternalHref(t):"javascript:void(0)",n=this.browser.locationControl?'onclick="return false;"':"",a='data-state-changes="'+encodeURIComponent(JSON.stringify(t))+'"';return'<a class="a-js-link" href="'.concat(r,'" ').concat(n," ").concat(a,">\n        ").concat(e,"</a>")}createInternalHref(t){var e,r=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=this.createNavigationState(t),a=window.location.protocol+"//"+(window.location.host?window.location.host:""),i=[];n.listId?(e=a+"/list/"+n.listId,n.dsId&&i.push(["ds",n.dsId])):e=a+"/ds/"+n.dsId,n.path&&i.push(["path",n.path]),n.viewMode&&i.push(["mode",n.viewMode]),n.format&&i.push(["format",n.format]);for(var s=0;s<i.length;s++){var o="&";0===s&&(o="?"),e+=o+i[s][0]+"="+i[s][1]}return r?this.escHtml(e):e}createNavigationState(t){var e={};return void 0!==t.listId?e.listId=t.listId:e.listId=this.browser.listId,void 0!==t.dsId?e.dsId=t.dsId:e.dsId=this.browser.dsId,void 0!==t.path?e.path=t.path:e.path=this.browser.path,void 0!==t.viewMode?e.viewMode=t.viewMode:e.viewMode=this.browser.viewMode,void 0!==t.format?e.format=t.format:e.format=this.browser.format,e}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URL(t);if(window.location.hostname!==n.hostname){var a=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+a:r.style=a:r={style:a},r.target="_blank"}return'<a href="'+this.escHtml(t)+'"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right;\n            background-repeat: no-repeat;\n            background-size: 10px 10px;\n            padding-right: 13px; ";return/^https?:\/\/schema.org/.test(t)?e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-red.png);":e+="background-image: url(https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/external-link-icon-blue.png);",e}createHtmlLoading(){return'<div style="text-align: center">\n            <img src="https://raw.githubusercontent.com/semantifyit/ds-browser/main/images/loading.gif"\n             alt="Loading Animation" style="margin-top: 100px;">\n            </div>'}createHtmlTableRow(t,e,r,n,a){var i=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null,s=this.createMainCol(r,n,i)+a;return'<tr typeof="'.concat(t,'" resource="').concat(e,'">\n            ').concat(s,"\n            </tr>")}createMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(e,{property:t})+"</th>"}createCodeLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return"<code"+this.createHtmlAttr(e)+">"+t+"</code>"}createHtmlDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]);var a=this.createHtmlAttr(r),i=this.createHtmlAttr(n),s=t.map(t=>"<th>"+t+"</th>").join(""),o=e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join("");return'<table class="table definition-table" '.concat(a,">\n            <thead><tr>").concat(s,"</tr></thead>\n            <tbody ").concat(i,">\n            ").concat(o,"\n            </tbody></table>")}createHtmlMainContent(t,e){return'\n            <div>\n                <div id="mainContent" vocab="http://schema.org/" typeof="'.concat(t,'" resource="').concat(window.location,'">\n                    ').concat(e,"\n                </div>\n            </div>")}createHtmlExternalLinkLegend(){return'<p style="font-size: 12px; margin-top: 0">(<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle(""))+'"></span>External link<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle("http://schema.org")+" margin-left: 6px;")+'"></span>External link to schema.org )</p>'}createTermLink(t){var e,r=this.browser.sdoAdapter.getTerm(t),n=r.getVocabURLs();if(n)for(var a of n)if(/http(s)?:\/\/(staging\.)?semantify\.it\/voc\//.test(a)){e=a+"?term="+t;break}return e=e||r.getIRI(),this.createLink(e,r.getIRI(!0))}prettyPrintClassDefinition(t){return Array.isArray(t)?t.map(t=>this.prettyPrintIri(t)).join(", "):this.prettyPrintIri(t)}fade(t){var e=.05,r=setInterval(()=>{e>=1&&clearInterval(r),t.style.opacity=e,t.style.filter="alpha(opacity="+100*e+")",e+=.05*e},10)}discoverDsRootNode(t){return t.find(t=>Array.isArray(t["@type"])&&t["@type"].includes("sh:NodeShape")&&t["@type"].includes("schema:CreativeWork"))}}module.exports=Util;
